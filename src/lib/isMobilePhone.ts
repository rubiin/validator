import {IsMobilePhoneOptions} from "../interface/isMobilePhoneOptions.ts";
...
const defaultMobilePhoneOptions: IsMobilePhoneOptions = {
  strictMode: false,
};
...
export default function isMobilePhone(
  str: string,
  locale: string,
  options: IsMobilePhoneOptions = defaultMobilePhoneOptions,
): boolean {
